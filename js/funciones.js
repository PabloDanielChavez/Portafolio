// IDs
const link__instagram = document.querySelector("#link__instagram");
const link__whatsapp = document.querySelector("#link__whatsapp");
const link__youtube = document.querySelector("#link__youtube");
...
export function mostrarInformacionError() {
    informacionPortafolio__grid.innerHTML = `
        <li class="informacion-portafolio__box"><div class="informacion-portafolio__hf"><p class="informacion-portafolio__version-parrafo">0.0.4-Betha</p><p class="informacion-portafolio__fecha">20/3/2023</p><p class="informacion-portafolio__fecha">30/3/2023</p></div><div class="informacion-portafolio__texto"><p class="material-symbols-outlined informacion-portafolio__icono--error">error</p><p class="informacion-portafolio__parrafo">En progreso</p></div><div class="informacion-portafolio__texto"><p class="material-symbols-outlined informacion-portafolio__icono--error">error</p><p class="informacion-portafolio__parrafo">En progreso</p></div><div class="informacion-portafolio__texto"><p class="material-symbols-outlined informacion-portafolio__icono--error">error</p><p class="informacion-portafolio__parrafo">En progreso</p></div><div class="informacion-portafolio__texto"><p class="material-symbols-outlined informacion-portafolio__icono--error">error</p><p class="informacion-portafolio__parrafo">La API se encuentra deshabilitada, se mejorará el uso de esta.</p></div><div class="informacion-portafolio__texto"><p class="material-symbols-outlined informacion-portafolio__icono--done">check_circle</p><p class="informacion-portafolio__parrafo">Se le agrego un boton llamado 'Contacto' en la seccion 'Bienvenida' el cual muestra un formulario de contacto</p></div></li>
